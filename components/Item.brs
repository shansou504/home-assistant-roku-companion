...
sub updateContent()
    ...
    if m.top.itemContent.domain = "binary_sensor" or m.top.itemContent.domain = "switch"
    ...
    else if m.top.itemContent.domain = "light"
        if m.top.itemContent.state = "on"
            m.poster.uri = "pkg:/images/lightbulb-outline_48x48.png"
        else if m.top.itemContent.state = "off"
            m.poster.uri = "pkg:/images/lightbulb-off-outline_48x48.png"
        end if
    end if
...
sub updateFocus()
    if m.top.focusPercent > 0.5
        if m.top.itemContent.domain = "binary_sensor" or m.top.itemContent.domain = "switch"
            ...
            if m.poster.uri = "pkg:/images/lightbulb-outline_48x48.png"
                m.poster.uri = "pkg:/images/lightbulb-outline-focused_48x48.png"
            elseif m.poster.uri = "pkg:/images/lightbulb-off-outline_48x48.png"
                m.poster.uri = "pkg:/images/lightbulb-off-outline-focused_48x48.png"
            end if
        end if
        m.label.color = "#181818ff"
    else
        if m.top.itemContent.domain = "binary_sensor" or m.top.itemContent.domain = "switch"
            ...
            if m.poster.uri = "pkg:/images/lightbulb-outline-focused_48x48.png"
                m.poster.uri = "pkg:/images/lightbulb-outline_48x48.png"
            elseif m.poster.uri = "pkg:/images/lightbulb-off-outline-focused_48x48.png"
                m.poster.uri = "pkg:/images/lightbulb-off-outline_48x48.png"
            end if
        end if
